...
-- Assignment is a high-frequency path. Reporting history retention is handled by
-- the scheduled cleanup instead of paying two DELETE statements for every new
-- seat reception.
