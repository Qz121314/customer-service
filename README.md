...
> 本项目的核心不是长期客服 CRM，而是把前端产生的有效咨询流量，按产品负责范围、坐席在线状态、容量和每日上限，稳定地分配给具体客服。聊天只是流量接待载体。
...
| 客服管理中心      | 配置客服账号、负责范围、容量、每日接待上限和查看坐席流量统计 |
...
- 产品内容、前端页面和转化组管理；
- 流量套餐购买、支付、充值、商家余额和财务结算；
- 长期客户档案、CRM、工单、SLA 或营销自动化；
- 把临时访客发展成长期用户体系；
- 为了“大而全”增加多层企业 RBAC 或复杂审批。

按量套餐、总量和剩余额度应由上游销售/计费系统管理；本项目提供有效分发结果、唯一分发编号和坐席流量账本作为扣量与对账依据。
