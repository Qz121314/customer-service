...
test('automatic routing stays presence-agnostic while enforcing daily cap', () => {
  ...
  assert.match(routing, /a\.daily_conversation_limit/u);
  assert.match(routing, /agent_daily_stats/u);
  ...
  assert.match(editor, /每日接待上限参与自动分流/u);
});
